...
public class HelloWebServer {
    ...
    public static EventLoopGroup evg = null;
    ...
    public static void main(String[] args) throws Exception {
        ...
        UpStreamChannelPool upStreamChannelPool = new UpStreamChannelPool();
        Constants.pool.put("otherSCChannel",upStreamChannelPool);
        Constants.executor.execute(new Init(DEFAULT_UPSTREAM_LINK,upStreamChannelPool));
